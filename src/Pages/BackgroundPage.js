    ...
    return(
        <div className="background-container">
            <div className="text-container"> 
                ...
                <div className="links">
                <h5>LinkedIn: <a href="https://www.linkedin.com/in/kieran-man-b7a462209/">https://www.linkedin.com/in/kieran-man-b7a462209/</a></h5>
                <h5>Email: <a>kieranman2001qq@gmail.com</a></h5>
                </div>
            </div>
        </div>
    )
